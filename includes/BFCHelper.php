	...
	public static function stripInvalidXml($value)
{
	...
	public static function AddToFavourites($id) {
		...
		$counter = 1;
		$listFav = (string) $id;
		if (isset($_COOKIE[self::$favouriteCookieName]))
		{
			$arr= explode(",",$_COOKIE[self::$favouriteCookieName]);
...
//		if(!empty($params['searchtypetab'])){
//			$pars['searchtypetab'] = $params['searchtypetab'];
//		}
