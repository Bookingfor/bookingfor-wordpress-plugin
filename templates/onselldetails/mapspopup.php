...
<div class="com_bookingforconnector_map_resource" style="display:block;height: 100px;overflow:auto;width: 350px;">
	<div class="com_bookingforconnector_resource">
		<h3 class="bfi-title-name"><a class="com_bookingforconnector_resource-resource-nameAnchor" href="<?php echo $uri ?>"><?php echo  $resourceName?></a> </h3>
